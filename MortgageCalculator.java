...
public class MortgageCalculator {
    ...
    private static String[][] storingData(double principleAmount, double monthlyMortgagePayment, double monthlyInterestRate, int loanLengthMonths) {
        /*  
        ...
        */
        ...
        for(int i = 1; i <= loanLengthMonths; i++){
            ...
            // Incrementing cumulative values
    ...
    private static void amortizationScheduleTable(String[][] data){
        ...
        String[] columnNames = { "Payment Month", "Starting Balance", "Remaining Balance", "Payment Amount", "Total Amount Paid",
